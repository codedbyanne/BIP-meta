...
lambda_table <- data.frame(Model = c("2Ctrl_2Anc", "5Ctrl_2Anc", "10Ctrl_2Anc", "15Ctrl_2Anc",
                                     ...
                                     "2Ctrl_10Anc", "5Ctrl_10Anc", "10Ctrl_10Anc", "15Ctrl_10Anc",
                                     "2Ctrl_0Anc", "5Ctrl_0Anc", "10Ctrl_0Anc", "15Ctrl_0Anc"), lambda = NA)
...
### 2 Ctrl PCs, 0 Anc PCs ###
model_variables <- variables_df[, c(1:11)]
model_variables <- model_variables[, !names(model_variables) %in% high_vif]
...
# EXPORT
#save(DMPs, file = "output/RData/Sex_adjusted/DMPs_BaselineResponse_Sex_adjusted_2CtrlPCs_0AncPCs_limma.RData")

pdf(file = "output/Figures/Sex_adjusted/QQplot_CaseCtrl_Sex_adjusted_2CtrlPCs_0AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output/Figures/Sex_adjusted/QQplot_CaseCtrl_Sex_adjusted_2CtrlPCs_0AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
### 5 Ctrl PCs, 0 Anc PCs ###
model_variables <- variables_df[, c(1:14)]
model_variables <- model_variables[, !names(model_variables) %in% high_vif]
...
# EXPORT
#save(DMPs, file = "output/RData/Sex_adjusted/DMPs_BaselineResponse_Sex_adjusted_5CtrlPCs_0AncPCs_limma.RData")

pdf(file = "output/Figures/Sex_adjusted/QQplot_CaseCtrl_Sex_adjusted_5CtrlPCs_0AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output/Figures/Sex_adjusted/QQplot_CaseCtrl_Sex_adjusted_5CtrlPCs_0AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
if (nrow(samples) >= 25){
  ### 10 Ctrl PCs, 0 Anc PCs ###
  model_variables <- variables_df[, c(1:19)]
  model_variables <- model_variables[, !names(model_variables) %in% high_vif]
  ...
  # EXPORT
  #save(DMPs, file = "output/RData/Sex_adjusted/DMPs_BaselineResponse_Sex_adjusted_10CtrlPCs_0AncPCs_limma.RData")
  
  pdf(file = "output/Figures/Sex_adjusted/QQplot_CaseCtrl_Sex_adjusted_10CtrlPCs_0AncPCs_limma.pdf", width = 5, height = 5)
  qq(DMPs$P.Value)
  dev.off()
  
  png(file = "output/Figures/Sex_adjusted/QQplot_CaseCtrl_Sex_adjusted_10CtrlPCs_0AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
  qq(DMPs$P.Value)
  dev.off()
...
if (nrow(samples) >= 35){
  ### 15 Ctrl PCs, 0 Anc PCs ###
  model_variables <- variables_df[, c(1:24)]
  model_variables <- model_variables[, !names(model_variables) %in% high_vif]
  ...
  # EXPORT
  #save(DMPs, file = "output/RData/Sex_adjusted/DMPs_BaselineResponse_Sex_adjusted_15CtrlPCs_0AncPCs_limma.RData")
  
  pdf(file = "output/Figures/Sex_adjusted/QQplot_CaseCtrl_Sex_adjusted_15CtrlPCs_0AncPCs_limma.pdf", width = 5, height = 5)
  qq(DMPs$P.Value)
  dev.off()
  
  png(file = "output/Figures/Sex_adjusted/QQplot_CaseCtrl_Sex_adjusted_15CtrlPCs_0AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
  qq(DMPs$P.Value)
  dev.off()
