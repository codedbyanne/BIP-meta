...
print("8 - NORMALISATION & IMPUTATION - X CHR IN FEMALES")
...
load('output/RData/intensities_filtered_1e16_X_females.RData')
...
save(TypeII.Green, TypeII.Red, TypeI.Green.M, TypeI.Green.U, TypeI.Red.M, TypeI.Red.U, file = "output/RData/intensities_normalised_X_females.RData")
...
pdf("output/Figures/Distributions/beta_distribution_filtered_QN_1e16_X_females.pdf", width = 7, height = 5)
...
write_xlsx(num_na, path = "output/Tables/Nr_NAs_per_CpGs_X_females.xlsx")
...
# EXPORT
if (array.type == "EPICv2"){
  save(beta_imp, file = "output/RData/beta_filtered_QN_BMIQ_imputed_1e16_X_females.RData", compress=F)
}
if (array.type == "EPICv1" | array.type == "450K"){
  beta <- beta_imp
  save(beta, file = "output/RData/beta_final_X_females.RData", compress=F)
}
...
if (array.type == "EPICv2"){
  ...
  save(beta, file = "output/RData/beta_final_X_females.RData")
}
...
pdf("output/Figures/Distributions/Beta_distribution_final_X_females.pdf", width = 7, height = 5)
densityPlot(beta, main = "final beta - X females")
dev.off()
