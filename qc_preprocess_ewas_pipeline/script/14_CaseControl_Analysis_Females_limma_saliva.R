...
# MAKE FOLDERS
if (!dir.exists("output/Figures/Females")) dir.create("output/Figures/Females")
if (!dir.exists("output/Tables/Females")) dir.create("output/Tables/Females")
if (!dir.exists("output/RData/Females")) dir.create("output/RData/Females")
...
load("output/RData/Mvalues_final_combined_X_females.RData")
...
# SELECT SAMPLES
samples <- samplesheet[which(samplesheet$Sex == "F"), ]
...
print(paste0("Nr of Females included: ", length(samples$Basename)))
write_xlsx(samples, path = "output/Tables/Females/Final_samplesheet_CaseCtrl.xlsx")
...
write_xlsx(vif_obj, path = "output/Tables/Females/VIF_CaseCtrl_Females.xlsx")
...
# EXPORT
#save(DMPs, file = "output/RData/Females/DMPs_BaselineResponse_Females_2CtrlPCs_2AncPCs_limma.RData")

pdf(file = "output/Figures/Females/QQplot_CaseCtrl_Females_2CtrlPCs_2AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output/Figures/Females/QQplot_CaseCtrl_Females_2CtrlPCs_2AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output/RData/Females/DMPs_BaselineResponse_Females_5CtrlPCs_2AncPCs_limma.RData")

pdf(file = "output/Figures/Females/QQplot_CaseCtrl_Females_5CtrlPCs_2AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output/Figures/Females/QQplot_CaseCtrl_Females_5CtrlPCs_2AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output/RData/Females/DMPs_BaselineResponse_Females_10CtrlPCs_2AncPCs_limma.RData")

pdf(file = "output/Figures/Females/QQplot_CaseCtrl_Females_10CtrlPCs_2AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output/Figures/Females/QQplot_CaseCtrl_Females_10CtrlPCs_2AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output/RData/Females/DMPs_BaselineResponse_Females_15CtrlPCs_2AncPCs_limma.RData")

pdf(file = "output/Figures/Females/QQplot_CaseCtrl_Females_15CtrlPCs_2AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output/Figures/Females/QQplot_CaseCtrl_Females_15CtrlPCs_2AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output/RData/Females/DMPs_BaselineResponse_Females_2CtrlPCs_5AncPCs_limma.RData")

pdf(file = "output/Figures/Females/QQplot_CaseCtrl_Females_2CtrlPCs_5AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output/Figures/Females/QQplot_CaseCtrl_Females_2CtrlPCs_5AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output/RData/Females/DMPs_BaselineResponse_Females_5CtrlPCs_5AncPCs_limma.RData")

pdf(file = "output/Figures/Females/QQplot_CaseCtrl_Females_5CtrlPCs_5AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output/Figures/Females/QQplot_CaseCtrl_Females_5CtrlPCs_5AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output/RData/Females/DMPs_BaselineResponse_Females_10CtrlPCs_5AncPCs_limma.RData")

pdf(file = "output/Figures/Females/QQplot_CaseCtrl_Females_10CtrlPCs_5AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output/Figures/Females/QQplot_CaseCtrl_Females_10CtrlPCs_5AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output/RData/Females/DMPs_BaselineResponse_Females_15CtrlPCs_5AncPCs_limma.RData")

pdf(file = "output/Figures/Females/QQplot_CaseCtrl_Females_15CtrlPCs_5AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output/Figures/Females/QQplot_CaseCtrl_Females_15CtrlPCs_5AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output/RData/Females/DMPs_BaselineResponse_Females_2CtrlPCs_10AncPCs_limma.RData")

pdf(file = "output/Figures/Females/QQplot_CaseCtrl_Females_2CtrlPCs_10AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output/Figures/Females/QQplot_CaseCtrl_Females_2CtrlPCs_10AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output/RData/Females/DMPs_BaselineResponse_Females_5CtrlPCs_10AncPCs_limma.RData")

pdf(file = "output/Figures/Females/QQplot_CaseCtrl_Females_5CtrlPCs_10AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output/Figures/Females/QQplot_CaseCtrl_Females_5CtrlPCs_10AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output/RData/Females/DMPs_BaselineResponse_Females_10CtrlPCs_10AncPCs_limma.RData")

pdf(file = "output/Figures/Females/QQplot_CaseCtrl_Females_10CtrlPCs_10AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output/Figures/Females/QQplot_CaseCtrl_Females_10CtrlPCs_10AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT
#save(DMPs, file = "output/RData/Females/DMPs_BaselineResponse_Females_15CtrlPCs_10AncPCs_limma.RData")

pdf(file = "output/Figures/Females/QQplot_CaseCtrl_Females_15CtrlPCs_10AncPCs_limma.pdf", width = 5, height = 5)
qq(DMPs$P.Value)
dev.off()

png(file = "output/Figures/Females/QQplot_CaseCtrl_Females_15CtrlPCs_10AncPCs_limma.png", width = 5, height = 5, units = "in", res = 300)
qq(DMPs$P.Value)
dev.off()
...
# EXPORT LAMBDA TABLE
write_xlsx(lambda_table, path = "output/Tables/Females/Lambda_CaseCtrl_Females_limma.xlsx")
